...
[篩選條件三]
"爬蟲-台銀匯率" VB指令 產生 "ExchangeRates" 資料表，供後續提供正確匯率使用
"將正確匯率及明細帳統整為新表" 查詢指令 產生 "ledger_mix_exchange_rate" 資料表，
"計算借貸方差異金額及比率" 查詢指令 產生 "different_amount_and_percentage" 資料表
"先篩選出大於10%再篩選差異金額超過門檻之列" 查詢指令 產生 "abnormal_list" 資料表，
"併入明細帳並列出所有異常分錄" 查詢指令 產生 "all_abnormal_entry" 資料表